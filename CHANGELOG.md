...
All notable changes to ChunkDoctor are documented here. The project follows
...
- Entity, villager, item, vehicle, hopper, furnace, redstone, spawner, container,
  and block-entity metrics.
...
[1.0.0]: https://github.com/denfry/ChunkDoctor/releases/tag/v1.0.0
